...
export function useStakingInfo(active: boolean | undefined = undefined, pairToFilterBy?: Pair | null): StakingInfo[] {
  ...
  // console.log("Master Info is", masterInfo)

  const tokensWithPrices = useTokensWithWethPrices()
  // console.log("Token with Prices", tokensWithPrices)
  ...
  // console.log("Account mapping is", pidAccountMapping)
  ...
  let adjustedPids = pids.map(pid => pid)
